...
unstructured_parking.ipynb
video_inference_tracking.ipynb
...
Class		Test mAP50	mAP50-95
Drivable_area	0.979		0.825
Non_drivable	0.995		0.843
Vehicle		0.701		0.517
Average		0.892		0.728
...
Video Inference with Tracking (Extended Demo)

Demonstrates model performance on continuous dashcam video.
Extension of the core project (not the primary focus).

Approach:

Frame-by-frame YOLO inference
Built-in tracking (ByteTrack) for object consistency
...
The demo video is available in:
assets/examples/
